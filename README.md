...
-Concurrencia: El servidor es multihilo, para ello usamos la biblioteca threading para gestionar solicitudes simultáneas sin que ocurra un bloqueo cuando dos personajes o más hagan varias solicitudes a la vez.
